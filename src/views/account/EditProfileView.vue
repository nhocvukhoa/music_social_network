<template>
	<div id="editProfile" class="container max-w-4xl mx-auto flex flex-col mt-2 px-6 h-auto">
		...
		<div class="flex flex-wrap mt-4 mb-4">
			<div class="w-full sm:w-1/2 px-3 pt-3 sm:pt-0">
				<DisplayCropperButton label="Profile Image"
		...
		<div class="flex flex-wrap mt-4 mb-4">
			<div class="w-full px-3 pt-3 sm:pt-0">
				<TextArea label="description"
					...
					error="This is a text error"></TextArea>
			</div>
		</div>
