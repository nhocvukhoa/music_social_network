<template>
  <div>
    <button 
      @click="open =! open" 
      class="bg-transparent hover:bg-green-400 text-white font-semibold hover:text-white
      py-1 px-2 hover:transparent rounded">
    ...
    <div 
      ...
      class="animated slideInDown faster fixed w-full h-full top-0 left-0 flex justify-center backdrop-blur-sm">
        ...
        <div class="my-auto fixed w-80 pt-16">
          <p class="text-center text-white text-2xl font-bold">Menu</p>
          <div class="pt-2">
            <RouterLinkButton 
              @click="open =! open"
              btnText="Profile"
            ...
            <RouterLinkButton 
              ...
              color="green"
              url="/account/posts"
              class="w-full text-center text-lg text-white mt-2" />
            <RouterLinkButton 
              btnText="Close"
              color="red"
              url="/account/profile"
